...
<table>
  ...
  <tbody>
    ...
    <tr><td>Insurance details</td><td>As a practice manager, I want a way to get a copy of patient's insurance details so that I can verify that their doctor are sure of their payment after the visit session completes.</td><td>Most times practice manager are concerned with the payment aspect of their doctors service. Patient may pay out of pocket or via an insurance agency (with copay or not). Leaving the out of pocket aspect aside, payment concerned with insurance are required to be validated before any medical service is provided by the doctor. The aim of practice manager is to avoid any insurance frauds, providing lesser credit to a doctor's service. In other cases, a practice manager may also find their patients troubled with their medical coverage support with their insurance. Question like whether a doctor is within a network may hinder at building a strong relationship with their patients.</td><td>2 story points</td></tr>
    <tr><td>Progress Note documentations</td><td>As a doctor, I want means to record few progress notes on a particular patient with either a form fillup and submission or by typing freely inside of a textbox so that I can document notes about the patient with details upon their visit for any future references.</td><td>Progress notes are basically indicators for doctors to keep track of their patient from visit to visit. A progress notes can give a measurement on how the patient is performing healthwise after a prior and before a next visit. As described in **Add a new Visit**,  This feature is set to be organized and made spacific to a single visit.</td><td>2 story points</td></tr>
    <tr><td>Lab and Medications</td><td>As a doctor, I want to see the lab reports of my patients so that I can get clear picture on their progress status in undertaking lab work, about lab reports generation stage status or taking a check over the completed lab work thats shared with the patient</td><td>In order to get overall idea about the patient health or to improve the health of the patient, doctors recommends to take medical prescriptions from pharmacy or to perform blood-testings at labs to get better understanding about their patient. This will also indicate a patients before about things they need to carry out before they follow up the doctor they are attending. As described in **Add a new Visit**,  This feature is set to be organized and made spacific to a single visit.</td><td>3 story points</td></tr>
